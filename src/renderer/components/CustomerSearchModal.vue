<template>
<div>
  <b-modal id="modal-search-customer" size="lg" ok-only ok-title="닫기">
    <b-container fluid>
      <b-card bg-variant="light" class="my-2">
        <b-container fluid>
          <b-row class="my-1">
            ...
            <b-col><b-input v-model="search.phone" @keyup.enter="tableReload"></b-input></b-col>
          </b-row>
          <b-row class="my-1">
            <b-col cols="12">
              <b-button @click="tableReload">검색</b-button>
              <b-button v-b-modal.modal-add-customer variant="success">등록</b-button>
            </b-col>
          </b-row>
        </b-container>
      </b-card>
